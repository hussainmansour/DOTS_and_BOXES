int checkboxes (int row,int col,int size,char comp[size][size],char gamearr[size][size],int gamer,int totallines,int movesplayed[totallines][7],int nofmoves,int ai)
{
    int check=0;
    if (row%2==0)          // vertical
    {
